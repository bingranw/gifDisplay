...
//draw event display
  ...
  TLatex tx_leg;
  tx_leg.SetTextAngle(90);
  tx_leg.SetTextSize(0.025);
  tx_leg.DrawLatexNDC(0.03, 0.1, legendName);
...
//strip display
  ...
  TPaveText *pt3 = new TPaveText(0.4, 0.91, 0.6, 0.94,"NDC");
...
//wire display
  ...
  TPaveText *pt1 = new TPaveText(0.4, 0.91, 0.6, 0.94, "NDC");
...
//comparator display
  ...
  // gPad->SetTopMargin(0.15);
  gPad->SetBottomMargin(0.2);
  TPaveText *pt4 = new TPaveText(0.4, 0.91, 0.6, 0.94, "NDC");
